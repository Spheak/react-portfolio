...
const Contact = () => {
        return (
          ...
          >
            ...
            <form className="border-2 border-primary p-4 flex flex-col gap-5">
              ...
              <Button className="mt-5 bg-background hover:bg-background shadow-none border-primary border rounded-none text-foreground cursor-pointer active:bg-primary active:text-white">
